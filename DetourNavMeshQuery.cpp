...
// Match the client path selection by using Dijkstra-style expansion instead
// of an A* heuristic. With the old heuristic, equal-cost corridor choices in
// dense navmeshes could diverge from the client route.
static const float H_SCALE = 0.0f;
